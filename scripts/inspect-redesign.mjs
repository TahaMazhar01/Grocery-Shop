...
await load();
const scene=page.locator('.hero-grocery-layer');const first=await scene.evaluate(e=>getComputedStyle(e).transform);await page.waitForTimeout(650);const second=await scene.evaluate(e=>getComputedStyle(e).transform);
